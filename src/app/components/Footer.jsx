...
import { FaFacebook, FaGooglePlusG, FaLinkedinIn, FaPinterest, FaRss, FaVimeo } from "react-icons/fa";
import Nav from "./Nav";

import { FaFacebookF, FaWhatsapp, FaLinkedin, FaShareAlt } from "react-icons/fa";
    ...
    return (
        ...
        <>
            <div className="fixed bottom-4 right-2  lg:right-4 z-50 space-y-2 flex flex-col">
                {/* Facebook */}
                <a
                    href="https://www.facebook.com/profile.php?id=61572902381558&rdid=cQzCph1JOl2ZtBWb&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F14enGshc67%2F#"
                    target="_blank"
                    ...
                    <div className="mb-8 ">
                        ...
                        <ul className="flex flex-wrap ">
                            ...
                            {[
                                ...
                                <li key={idx}>
                                    <button className={`hover:shadow rounded-full my-2 py-2 px-4 cursor-pointer transition text-lg
                            `}>
                                        <a href={item.href} >
                                            {item.label}
                    ...
                    <div className="bg-[#000] border-t pt-3">
                        <div className="container mx-auto text-center text-white block lg:flex justify-between items-center ">
                            ...
                            <div className="flex justify-center gap-4  text-xl my-3 lg:my-0">
                                ...
                                <Link href="#"><FaRss /></Link>
                                <Link href="#"><FaVimeo /></Link>
                            </div>
                            <span className="text-lg text-center ">
                                © Copyright 2025 - Social Scholars. Designed By <Link href="https://www.futuretouch.in/" target="_blank" rel="nofollow noopener noreferrer" >Future Touch</Link>
                            </span>
                        </div>
                    </div>
                </div>
