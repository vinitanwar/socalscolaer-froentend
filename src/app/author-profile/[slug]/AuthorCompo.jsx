...
{!other && <>
    ...
    <div className="about-author-area ">
        <div className={`bg-gray-100 container mx-auto py-10 px-5 lg:px-24`}>
              ...
              <div className="author-content block lg:flex gap-5">
                ...
                <div className="thumb mb-4 ">
                  <div className="block lg:flex items-end gap-4 mb-2 mt-4 lg:mt-0">
                    <h3 className="text-2xl font-semibold ">{authordata?.name}</h3>
                    <ul className="text-sm   space-y-1 gap-2 flex">
                      <li>News Writer</li>
                      <li>
                        <span>
                          Since:{" "}
                          <span className="font-medium">{authordata?.updated_at.split("T")[0]}</span>
                        </span>
                      </li>
                    </ul>
                  </div>
...
{other && <div
            className="border p-3 lg:p-6 mb-10 block lg:flex gap-4"
            id="editor"
          >
            ...
            <div>
              <div className="flex justify-between items-center mt-2 lg:mt-0 mb-2">
              ...
              <p className="text-sm mb-2 text-justify"   dangerouslySetInnerHTML={{
    __html:authordata?.about_author.length>=200? `${authordata?.about_author.slice(0,200)}. . .`:authordata?.about_author,
  }}>
