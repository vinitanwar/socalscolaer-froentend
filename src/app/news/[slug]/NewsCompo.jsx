    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-5">
        <div className="text-center">
          ...
          <p className="">We couldn't find the article you're looking for.</p>
        </div>
      </div>
    );
  }
        ...
        <div className="lg:col-span-8 px-0 lg:px-5">
          ...
          <div className="block lg:flex gap-4 mb-6 mt-2">
            {newsData?.editor && newsData.editor != 0 && (
              <span className=" font-semibold hover:underline flex gap-1">
                <span className="hidden lg:block">By</span> <a href="#editor">{newsData?.editor}</a> 
              </span>
            )}
...
<section id="editor">
          {newsData?.editor && newsData.editor != 0 && (
            <AuthorCompo
              slug={newsData?.editor.split(" ").join("-")}
              other={true}
            />
          )}
          </section>
